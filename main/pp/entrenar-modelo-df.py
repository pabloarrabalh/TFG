...
def entrenar_modelos_gridsearch(X_train, X_test, y_train, y_test, variables):
    ...
    visualizar_feature_importancia(fi_rf, "Random Forest - Top 20 Features", "01_feature_importance_rf.png", top_n=20)
    ...
    if fi_xgb is not None:
        ...
        print(f"  ✅ Feature importance guardado\n")
    visualizar_feature_importancia(fi_xgb, "XGBoost - Top 20 Features", "02_feature_importance_xgb.png", top_n=20)
    ...
    if fi_ridge is not None:
        ...
        print(f"  ✅ Feature importance guardado\n")
    visualizar_feature_importancia(fi_ridge, "Ridge - Top 20 Features", "03_feature_importance_ridge.png", top_n=20)
    ...
    if fi_elastic is not None:
        ...
        print(f"  ✅ Feature importance guardado\n")
    visualizar_feature_importancia(fi_elastic, "ElasticNet - Top 20 Features", "04_feature_importance_elastic.png", top_n=20)
